...
function OpenIssueIcon() {
  return (
    <svg
      ...
      fill="currentColor"
      aria-hidden
      className="shrink-0 mt-0.5 text-[#3fb950]"
    >
...
function DoneIcon() {
  return (
    <svg
      ...
      fill="currentColor"
      aria-hidden
      className="shrink-0 mt-0.5 text-[#a371f7]"
    >
        ...
        <div className="min-w-0 flex-1">
          ...
          {(finding.instruction || showRepo) && (
            <div className="mt-1.5 flex items-center gap-2 text-xs">
              {finding.instruction && (
                <span className="rounded-full bg-[#1f6feb]/15 px-2 py-0.5 text-[#58a6ff] ring-1 ring-inset ring-[#1f6feb]/30">
                  → AI fix queued
                </span>
              )}
              {showRepo && (
